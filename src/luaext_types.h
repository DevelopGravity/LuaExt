...
#define LUAEXT_CAPS_UNTRUSTED ( \
	LUAEXT_CAP_COROUTINES | \
	LUAEXT_CAP_OS_TIME | \
	LUAEXT_CAP_DEBUG_TRACEBACK | \
	LUAEXT_CAP_UTF8)
...
#define LUAEXT_CAPS_TRUSTED ( \
	LUAEXT_CAPS_UNTRUSTED | \
	LUAEXT_CAP_COMPILE_AT_RUNTIME | \
	LUAEXT_CAP_DUMP_BYTECODE | \
	LUAEXT_CAP_REQUIRE | \
	LUAEXT_CAP_VFS | \
	LUAEXT_CAP_VFS_WRITE | \
	LUAEXT_CAP_DEBUG_INTROSPECT | \
	LUAEXT_CAP_GC_CONTROL | \
	LUAEXT_CAP_WARN)
...
typedef enum {
	LUAEXT_OVERFLOW_TRUNCATE = 0,
	LUAEXT_OVERFLOW_FAIL
} luaext_overflow;
